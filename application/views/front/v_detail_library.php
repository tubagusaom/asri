            ...
            <div class="mailbox-content">
               <div class="mail-toolbar clearfix">
                ...
                <table class="table">
                    <tbody>
											<?php
								 		 			foreach ($event->result_array() as $i) {
								 		 					$id=$i['id'];
                                                            $judul=$i['judul'];
                        ...
                        <tr class="table-row">
                            ...
                            <td class="table-text">
                            	<h6><a href="<?php echo base_url().'backend/library/download/'.$id;?>" ><?php echo $judul; ?></a></h6> <br><br>
                                
                            </td>
                            <td>
                            <h6>Kategori : &nbsp; <?php echo $deskripsi; ?></h6> 	
                            </td>
                            <td class="march">
