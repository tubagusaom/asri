 ...
 <!-- /.sidebar -->
 	...
 	<!--banner-->
		    <div class="banner">
				...
				<div class="asked">
				 <img  src="<?php echo base_url().'assets/gambars/'.$n['gambar'];?>" alt="" />

						<div class="questions">
							<h5><?php echo $n['judul'];?></h5>
							  <p><?php echo $n['tglpost'];?>, by <?php echo $n['user'];?> </p>
				        <p><?php echo $n['isi'];?></p>
				        </div>
...
<div class="modal" id="ModalAddNew" tabindex="-1" role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
			...
			<form  method="post" action="<?php echo base_url().'backend/post/simpan_det_pesan'?>" enctype="multipart/form-data">
                  ...
                  <div class="modal-footer">
                      <input type="hidden" name="kode" value="<?php echo $n['idberita'];?>">
