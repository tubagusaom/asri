		...
		<div class="profil-bottom">
			...
			<div class="profile-bottom-top">
				<div class="col-md-2 profile-hari">
														...
														<h6><?php echo $b->tglpelaksanaan?></h6>
														<h6><?php echo $b->hari?></h6> 
			...
			<div class="col-md-6 profile-text">
				<h6><?php echo $b->judul?></h6>
			
        <div class="profile-btn">
                  
                  <a href="<?php echo base_url().'backend/event/detail_event/'.$b->idevent;?>" >Read More >></a>

        </div>
			</div>

			<div class="col-md-4 profile-bottom-img">
		 <img width="345px" height="300px" src="<?php echo base_url().'assets/gambars/'.$b->gambar;?>" alt="" />
		</div>
			<div class="clearfix"></div>
			</div>
		</div>
