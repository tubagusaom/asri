...
<head>
  ...
  <title>Asri-Connect | Inbox</title>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Discussion</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'backendadmin/inbox/hapus_inbox'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $inbox_id;?>"/> 
                            <p>Apakah Anda yakin mau menghapus judul dari <b><?php echo $inbox_email;?></b>?</p>
