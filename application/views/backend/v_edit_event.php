...
<head>
  ...
  <title>Asri-Connect | Edit Event</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Event Post</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'backendadmin/event/update_event'?>" method="post" enctype="multipart/form-data">
		  <?php 
        $b=$data->row_array();
      ?>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="hidden" name="kode" value="<?php echo $b['idevent'];?>">
